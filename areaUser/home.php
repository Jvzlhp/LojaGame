...
<!-- <div id="carouselExampleIndicators" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../img/site/hasha.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="../img/site/fortnite.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="../img/site/metro.png" class="d-block w-100" alt="...">
    </div>
  </div>
  ...
  display:block;
    ...
    .carousel-item {
      ...
      opacity: 0; /* Inicialmente invisível */
        width: 100%; /* Largura total do item em telas pequenas */
    }

    .form {
        width: 90%; /* Largura um pouco menor em telas menores */
    }
}

@media (max-width: 480px) {
    .title {
        font-size: 1rem; /* Ajusta o tamanho da fonte em telas pequenas */
    }

    .title2 {
        font-size: 0.9rem; /* Ajusta ainda mais em telas pequenas */
    }
}
